...
import { AdminKontakte } from './admin/pages/AdminKontakte';
      ...
      <Router>
        <div className="min-h-screen flex flex-col">
          <Routes>
            ...
            <Route path="/dashboard" element={<ProtectedRoute><><Header /><main className="flex-1"><Dashboard /></main><Footer /></></ProtectedRoute>} />
            <Route path="/upload" element={<ProtectedRoute><><Header /><main className="flex-1"><Upload /></main><Footer /></></ProtectedRoute>} />
            <Route path="/requests" element={<ProtectedRoute><><Header /><main className="flex-1"><Requests /></main><Footer /></></ProtectedRoute>} />
            <Route path="/requests/:id" element={<ProtectedRoute><><Header /><main className="flex-1"><RequestDetail /></main><Footer /></></ProtectedRoute>} />
            <Route path="/request/new" element={<ProtectedRoute><><Header /><main className="flex-1"><NewRequest /></main><Footer /></></ProtectedRoute>} />
            <Route path="/notifications" element={<ProtectedRoute><><Header /><main className="flex-1"><Notifications /></main><Footer /></></ProtectedRoute>} />
            ...
            <Route path="/admin" element={<AdminRoute><AdminLayout /></AdminRoute>}>
              ...
              <Route path="kontakte" element={<AdminKontakte />} />
